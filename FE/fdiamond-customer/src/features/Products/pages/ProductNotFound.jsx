                ...
                <div className='h-screen grid grid-cols-2'>
                    <div className="flex flex-col px-[3.5rem] justify-center bg-gray-50">
                        <div className=' font-gantari flex flex-col text-center'>
                            <p className='text-[3.5rem] font-[650] text-[#000035]'>NO PRODUCT FOUND</p>
                            <p className='text-[1.5rem] font-[380] mt-5'>We’re sorry, the product you’re looking for is not available.</p>
                            {/* mt-[4.3rem] */}
