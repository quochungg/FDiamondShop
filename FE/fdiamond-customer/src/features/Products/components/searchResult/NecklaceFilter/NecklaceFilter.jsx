...
import { NecklaceStyleMenu, MetalMenu } from 'src/features/Products/components/index';


const NecklaceFilter = ({ searchParams, handleSearchParams }) => {
